...
import com.exorath.service.kit.service.MongoService;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Created by Toon on 4/2/2017.
 */
public class Main {
    private Service service;
    private static final Logger LOG = LoggerFactory.getLogger(com.exorath.service.currency.Main.class);
    ...
    public Main() {
        this.service = new MongoService(MongoProvider.getEnvironmentMongoProvider().getClient(), TableNameProvider.getEnvironmentTableNameProvider("DB_NAME").getTableName(),
                new CurrencyServiceAPI(TableNameProvider.getEnvironmentTableNameProvider("CURRENCY_SERVICE_ADDRESS").getTableName()));
